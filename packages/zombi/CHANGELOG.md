...
- Add simple code cleanups ([@smithki](https://github.com/smithki))
...
- Cleanup 'Directory' types ([@smithki](https://github.com/smithki))
...
- V4 changes ([@smithki](https://github.com/smithki))
...
- Surface a utility for merging prompts together with strong typing ([@smithki](https://github.com/smithki))
